    ...
    <div class="row">
       <div class="col-lg-12">
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form id="form-title" name="form-title" method="POST" class="p-20">
                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none"> 
                        <input type="hidden" name="action" value="{action}" style="display: none"> 
                        <input type="hidden" name="id_title" value="{id_title}" style="display: none"> 
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       <label class="control-label"><small>Nama Jabatan</small></label>
                                       <input  class="form-control error" type="text" value="{nm_title}" id="nm_title" name="nm_title"  
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       <label class="control-label"><small>Kode Jabatan</small></label>
                                       <input  class="form-control error" type="text" value="{code_title}" id="code_title" name="code_title"  
                                                data-validation="[NOTEMPTY]"
		...
		submit: {
			...
			callback: {
				...
				onSubmit: function(node) {
					ajaxFormSubmit("form-title", "/form_submit");
				},
